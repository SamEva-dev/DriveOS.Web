...
import {
  ActivateTrainingContractResponse,
  ApplyContractAmendmentResponse,
  CompleteTrainingContractRequest,
  CompleteTrainingContractResponse,
  ExpireTrainingContractResponse,
  CreateContractAmendmentRequest,
  GeneratedTrainingContract,
  RecordTrainingContractSignatureRequest,
  RecordTrainingContractSignatureResponse,
  SaveTrainingContractSignatoryRequest,
  SendTrainingContractForSignatureResponse,
  SuspendTrainingContractRequest,
  SuspendTrainingContractResponse,
  TerminateTrainingContractRequest,
  TerminateTrainingContractResponse,
  TrainingContractDetail,
  TrainingContractListItem,
  ContractDocument,
  PagedResult,
  SearchTrainingContractsParameters,
...
export class ContractsApiService {
  ...
  searchTrainingContracts(
    parameters: SearchTrainingContractsParameters = {},
  ): Observable<PagedResult<TrainingContractListItem>> {
    ...
    return this.http.get<PagedResult<TrainingContractListItem>>(`${this.baseUrl}/search`, {
      params,
    });
  }
  ...
  addSignatory(
    contractId: string,
    request: SaveTrainingContractSignatoryRequest,
  ): Observable<string> {
  ...
  updateSignatory(
    ...
    request: Omit<
      SaveTrainingContractSignatoryRequest,
      'kind' | 'personId' | 'representedOrganizationId'
    >,
  ): Observable<void> {
  ...
  decideSignatoryAuthority(
    ...
    return this.http.post<void>(
      `${this.baseUrl}/${contractId}/signatories/${signatoryId}/authority`,
      { approved, reason: reason || null },
    );
  }
  ...
  recordSignature(
    ...
    request: RecordTrainingContractSignatureRequest,
  ): Observable<RecordTrainingContractSignatureResponse> {
  ...
  activateTrainingContract(contractId: string): Observable<ActivateTrainingContractResponse> {
    return this.http.post<ActivateTrainingContractResponse>(
      `${this.baseUrl}/${contractId}/activate`,
      {},
    );
  }

  suspendTrainingContract(
    contractId: string,
    request: SuspendTrainingContractRequest,
  ): Observable<SuspendTrainingContractResponse> {
    return this.http.post<SuspendTrainingContractResponse>(
      `${this.baseUrl}/${contractId}/suspend`,
      request,
    );
  }

  terminateTrainingContract(
    contractId: string,
    request: TerminateTrainingContractRequest,
  ): Observable<TerminateTrainingContractResponse> {
    return this.http.post<TerminateTrainingContractResponse>(
      `${this.baseUrl}/${contractId}/terminate`,
      request,
    );
  }

  completeTrainingContract(
    contractId: string,
    request: CompleteTrainingContractRequest,
  ): Observable<CompleteTrainingContractResponse> {
    return this.http.post<CompleteTrainingContractResponse>(
      `${this.baseUrl}/${contractId}/complete`,
      request,
    );
  }

  expireTrainingContract(contractId: string): Observable<ExpireTrainingContractResponse> {
    return this.http.post<ExpireTrainingContractResponse>(
      `${this.baseUrl}/${contractId}/expire`,
      {},
    );
  }
  ...
  createAmendment(
    contractId: string,
    request: CreateContractAmendmentRequest,
  ): Observable<{ amendmentId: string; amendmentNumber: number; status: string }> {
    return this.http.post<{ amendmentId: string; amendmentNumber: number; status: string }>(
      `${this.baseUrl}/${contractId}/amendments`,
      request,
    );
  }

  recordAmendmentSignedProof(
    contractId: string,
    amendmentId: string,
    request: { signedDocumentReference: string; documentSha256: string; signedAtUtc: string },
  ): Observable<void> {
    return this.http.post<void>(
      `${this.baseUrl}/${contractId}/amendments/${amendmentId}/signed-proof`,
      request,
    );
  }
  ...
  applyAmendment(
    contractId: string,
    amendmentId: string,
  ): Observable<ApplyContractAmendmentResponse> {
    return this.http.post<ApplyContractAmendmentResponse>(
      `${this.baseUrl}/${contractId}/amendments/${amendmentId}/apply`,
      {},
    );
  }

  cancelAmendment(contractId: string, amendmentId: string, reason: string): Observable<void> {
    return this.http.post<void>(`${this.baseUrl}/${contractId}/amendments/${amendmentId}/cancel`, {
      reason,
    });
  }
  ...
  addContractDocumentVersion(
    ...
    return this.http.post<ContractDocument>(
      `${this.baseUrl}/${contractId}/documents/${documentId}/versions`,
      formData,
    );
  }
  ...
  archiveContractDocument(contractId: string, documentId: string): Observable<void> {
    return this.http.post<void>(
      `${this.baseUrl}/${contractId}/documents/${documentId}/archive`,
      {},
    );
  }

  sendForSignature(contractId: string): Observable<SendTrainingContractForSignatureResponse> {
    return this.http.post<SendTrainingContractForSignatureResponse>(
      `${this.baseUrl}/${contractId}/send-for-signature`,
      {},
    );
  }
}
