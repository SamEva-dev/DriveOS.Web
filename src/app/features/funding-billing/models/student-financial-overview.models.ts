...
export interface StudentFinancialTotals {
  ...
  availableTrainingCredits: number;
}
export interface StudentFinancialAlerts {
  overdueInvoiceCount: number;
  overdueInstallmentCount: number;
  pendingReminderCount: number;
  failedPaymentCount: number;
  pendingFundingDecisionCount: number;
  expiringCreditAccountCount: number;
  pendingRefundCount: number;
  hasFinancialBlock: boolean;
}
export interface StudentFinancialNextInstallment {
  id: string;
  dueDate: string;
...
export interface StudentFinancialInvoiceSummary {
  id: string;
  number: string | null;
...
export interface StudentFinancialPaymentSummary {
  id: string;
  amount: number;
...
export interface StudentFinancialFundingPlanSummary {
  id: string;
  contractId: string;
  totalCost: number;
...
export interface StudentFinancialBillingPartySummary {
  id: string;
...
export interface StudentFinancialCreditSummary {
  id: string;
  creditType: string;
  purchased: number;
  reserved: number;
...
export interface StudentFinancialRefundSummary {
  id: string;
  paymentId: string;
  amount: number;
  status: string;
...
export interface StudentFinancialCreditNoteSummary {
  id: string;
  invoiceId: string;
  number: string | null;
  issueDate: string | null;
