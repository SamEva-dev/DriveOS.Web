...
export class DashboardPage {
  ...
  iconPath(icon: DashboardIcon): string {
    const paths: Record<DashboardIcon, string> = {
      building:
        'M4 21V7l8-4 8 4v14M9 21v-5h6v5M8 9h.01M12 9h.01M16 9h.01M8 12h.01M12 12h.01M16 12h.01',
      student:
      ...
      alert:
        'M10.3 2.9 1.8 17a2 2 0 0 0 1.7 3h17a2 2 0 0 0 1.7-3L13.7 2.9a2 2 0 0 0-3.4 0ZM12 9v4M12 17h.01',
