...
import { GetLeadsParameters, LeadSortField, SortDirection } from '../models/get-leads-parameters';
...
export class LeadsListStore {
  ...
  private readonly resource = httpResource<PagedResponse<LeadListItem>>(
    () => {
      ...
      if (parameters.assignedAdvisorId)
        params = params.set('assignedAdvisorId', parameters.assignedAdvisorId);
