...
describe('CommercialOffersApiService', () => {
  ...
  it('generates an offer from the validated assessment session', () => {
    service
      .generate('lead-1', {
        ...
        trainingCode: 'B',
        currency: 'EUR',
        validUntilUtc: '2026-09-12T00:00:00.000Z',
  ...
  it('creates a variant from an existing offer', () => {
    service
      .createVariant('offer-1', {
        trainingCode: 'B-CONFORT',
        validUntilUtc: '2026-09-12T00:00:00.000Z',
        estimatedFundingAmount: 0,
        financingNotes: null,
        conditions: null,
  ...
  it('sends an approved frozen offer to explicit recipients', () => {
    service
      .send('offer-1', {
        ...
        message: 'Message',
        language: 'fr',
        documentReference: 'offer.pdf',
        attachmentReferences: [],
        secureLinkLifetimeHours: 168,
      })
      .subscribe();
    ...
    request.flush({
      ...
      secureLinkExpiresAtUtc: '2026-08-19T00:00:00Z',
    });
  });
});
