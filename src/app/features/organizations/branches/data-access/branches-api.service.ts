...
} from '../models/change-branch-status-request';

import {
  CreateBranchRequest,
} from '../models/create-branch-request';

import {
  CreateBranchResponse,
} from '../models/create-branch-response';
...
import {
  UpdateBranchRequest,
} from '../models/update-branch-request';
...
export class BranchesApiService {
  ...
  ): Observable<CreateBranchResponse> {
