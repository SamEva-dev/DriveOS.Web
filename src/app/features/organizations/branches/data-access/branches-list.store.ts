...
const EMPTY_PAGE:
  ...
  pageNumber: 1,
  pageSize:
    DEFAULT_GET_BRANCHES_PARAMETERS.pageSize,
  totalCount: 0,
  totalPages: 0,
...
export class BranchesListStore {
  ...
  private readonly organizationIdSignal =
    signal<string | null>(null);

  private readonly parametersSignal =
    signal<GetBranchesParameters>({
      ...DEFAULT_GET_BRANCHES_PARAMETERS,
    });

  readonly organizationId =
    this.organizationIdSignal.asReadonly();
