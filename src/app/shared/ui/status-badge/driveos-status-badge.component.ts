...
export class DriveOsStatusBadgeComponent {
  ...
  readonly classes = computed(() => {
    const tones: Record<DriveOsStatusTone, string[]> = {
      ...
      info: ['bg-blue-50', 'text-blue-800', 'ring-blue-200', 'dark:bg-blue-950/50', 'dark:text-blue-200', 'dark:ring-blue-900'],
      success: ['bg-emerald-50', 'text-emerald-800', 'ring-emerald-200', 'dark:bg-emerald-950/50', 'dark:text-emerald-200', 'dark:ring-emerald-900'],
      warning: ['bg-orange-50', 'text-orange-800', 'ring-orange-200', 'dark:bg-orange-950/50', 'dark:text-orange-200', 'dark:ring-orange-900'],
      danger: ['bg-red-50', 'text-red-800', 'ring-red-200', 'dark:bg-red-950/50', 'dark:text-red-200', 'dark:ring-red-900'],
    };
  ...
  readonly dotClasses = computed(() => {
    const tones: Record<DriveOsStatusTone, string> = {
      neutral: 'bg-slate-400', info: 'bg-blue-500', success: 'bg-emerald-500', warning: 'bg-orange-500', danger: 'bg-red-500',
    };
